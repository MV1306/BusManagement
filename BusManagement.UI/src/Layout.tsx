...
const adminNavItems = [
  ...
  { to: '/mtcbatchscraper', icon: <BatchLabIcon />, label: 'MTC Batch Scraper', key: 'W', roles: ['Admin'] },
];
...
const titles: Record<string, { label: string; icon: React.ReactNode }> = {
  ...
  '/mtcbatchscraper':  { label: 'MTC Batch Scraper',  icon: <BatchLabIcon /> },
};
...
function BatchLabIcon()  { return <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 3H5a2 2 0 0 0-2 2v4m6-6h10a2 2 0 0 1 2 2v4M9 3v11l-4 7h14l-4-7V3"/><path d="M5 20h4M15 20h4"/></svg>; }
